...
public class MainInit extends JFrame {
    ...
    public void Init(){
        ...
        jTextArea.setBounds(80,40,300,190);
        Button button1=new Button("search");
        button1.setBounds(380,5,50,20);
        CallBackSearch mySearch=new CallBackSearch(hasMap,hashSet,arrayList,textField,jTextArea);
        ...
        JTextArea jTextArea2 =new JTextArea(20,10);
        jTextArea2.setBounds(130,40,300,190);
        button2.setBounds(230,5,50,20);
        CallBackSort sort=new CallBackSort(hasMap,hashSet,arrayList,jTextArea2);
